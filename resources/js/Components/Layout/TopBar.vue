        ...
        <div class="flex-1 max-w-2xl mx-4">
            <div class="relative">
                <input
                    ...
                    class="w-full px-4 py-2 pl-10 bg-charcoal border border-transparent rounded-lg text-slate-200 placeholder-slate-400 placeholder-slate-400 focus:bg-charcoal-light focus:border-arcane-periwinkle focus:ring-1 focus:ring-arcane-periwinkle focus:shadow-glow-arcane-sm transition-all"
                />
                <svg
